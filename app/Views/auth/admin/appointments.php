        ...
        <div class="col-12">
            ...
            <div class="card mt-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <form action="<?= base_url('admin/appointments/search') ?>" method="get" class="d-inline-block me-2">
                                ...
                                <?php if (!empty($appointments)): ?>
                                    <?php foreach ($appointments as $appointment): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('admin/patients/view/' . $appointment['patient_id']) ?>" class="text-decoration-none">

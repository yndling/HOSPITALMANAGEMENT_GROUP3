                ...
                <div class="col-md-8">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= base_url('admin/patients/edit/' . $patient['id']) ?>" class="btn btn-sm btn-outline-primary">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= base_url('admin/appointments/create?patient_id=' . $patient['id']) ?>" class="btn btn-sm btn-primary">
                        ...
                        <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php foreach ($appointments as $appointment): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('admin/appointments/view/' . $appointment['id']) ?>" class="btn btn-sm btn-outline-primary" title="View Details">
                                                            <i class="bi bi-eye"></i>
                                                        </a>
                                                        <a href="<?= base_url('admin/appointments/edit/' . $appointment['id']) ?>" class="btn btn-sm btn-outline-warning" title="Edit">
                            ...
                            <?php else: ?>
                                <div class="text-center py-4">
                                    ...
                                    <a href="<?= base_url('admin/appointments/create?patient_id=' . $patient['id']) ?>" class="btn btn-primary">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                <a href="<?= base_url('admin/appointments/create?patient_id=' . $patient['id']) ?>" class="btn btn-success">
                                    <i class="bi bi-calendar-plus"></i> Book Appointment
                                </a>
                                <a href="<?= base_url('admin/patients/edit/' . $patient['id']) ?>" class="btn btn-warning">
                                    <i class="bi bi-pencil-square"></i> Edit Patient
                                </a>
                                <a href="<?= base_url('admin/patients') ?>" class="btn btn-secondary">

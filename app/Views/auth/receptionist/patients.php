        ...
        <div class="col-12">
            ...
            <div class="card mt-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <form action="<?= base_url('receptionist/patients/search') ?>" method="get" class="d-inline-block me-2">
                        ...
                        <a href="<?= base_url('receptionist/patients/create') ?>" class="btn btn-primary">
                                ...
                                <?php if (!empty($patients)): ?>
                                    <?php foreach ($patients as $patient): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('receptionist/patients/view/' . $patient['id']) ?>" class="btn btn-sm btn-outline-primary" title="View Details">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="<?= base_url('receptionist/patients/edit/' . $patient['id']) ?>" class="btn btn-sm btn-outline-warning" title="Edit">
...
function confirmDelete(id) {
    if (confirm('Are you sure you want to delete this patient? This action cannot be undone.')) {
        window.location.href = '<?= base_url('receptionist/patients/delete/') ?>' + id;
    }
}
</script>

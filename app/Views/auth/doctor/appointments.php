...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <p class="lead">View and manage patient appointments.</p>
            ...
            <div class="card mt-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <form action="<?= base_url('doctor/appointments/search') ?>" method="get" class="d-inline-block me-2">
                        ...
                        <a href="<?= base_url('doctor/appointments/create') ?>" class="btn btn-primary">
                                ...
                                <?php if (!empty($appointments)): ?>
                                    <?php foreach ($appointments as $appointment): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('doctor/patients/view/' . $appointment['patient_id']) ?>" class="text-decoration-none">
...
function confirmDelete(id) {
    if (confirm('Are you sure you want to cancel this appointment? This action cannot be undone.')) {
        window.location.href = '<?= base_url('doctor/appointments/delete/') ?>' + id;
    }
}
</script>

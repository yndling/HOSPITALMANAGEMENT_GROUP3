                ...
                <div class="col-md-8">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= base_url('doctor/appointments/edit/' . $appointment['id']) ?>" class="btn btn-sm btn-outline-primary">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                <a href="<?= base_url('doctor/patients/view/' . $appointment['patient_id']) ?>" class="btn btn-outline-primary">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                ...
                                <form action="<?= base_url('doctor/appointments/status/' . $appointment['id']) ?>" method="post" class="mb-2">
                                    <?= csrf_field() ?>
                                ...
                                <a href="<?= base_url('doctor/appointments') ?>" class="btn btn-secondary">

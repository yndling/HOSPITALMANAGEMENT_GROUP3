...
<head>
    ...
    <title>Pharmacy - Healthcare Dashboard</title>
...
<body>
    <nav class="sidebar d-flex flex-column">
        ...
        <a href="/admin/pharmacy" class="nav-link active">Pharmacy</a>
    ...
    <main class="content">
        ...
        <table>
            ...
            <tbody>
                <!-- Pharmacy rows will be dynamically added here -->
                <tr>
                    <td>#001</td>
                    <td>*******</td>
                    <td>****</td>
                ...
                <tr>
                    ...
                    <td>$**</td>
                    <td>*****</td>
                    <td class="status-out-stock">Out Of Stock</td>
                    <td>***</td>
                </tr>
                <tr>
                    <td>#003</td>

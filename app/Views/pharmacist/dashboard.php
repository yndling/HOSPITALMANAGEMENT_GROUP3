...
<body>
    <nav class="sidebar">
        ...
        <a href="<?= base_url('/pharmacy/dashboard') ?>" class="nav-link active">Dashboard</a>
        <a href="<?= base_url('/pharmacy/medicines') ?>" class="nav-link">Medicines</a>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text"><?= $totalMedicines ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text"><?= $dispensedPrescriptions ?></p>
                    </div>
                </div>
            </div>
        </div>

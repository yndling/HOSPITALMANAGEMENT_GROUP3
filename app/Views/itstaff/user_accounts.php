...
<head>
    ...
    <title>User Accounts - IT Staff Dashboard</title>
...
<body>
    <nav class="sidebar d-flex flex-column">
        ...
        <a href="/itstaff/userAccounts" class="nav-link active">User Accounts</a>
    ...
    <main class="content">
        ...
        <button class="btn btn-primary add-user-btn">Add User +</button>

...
class ReceptionistController extends BaseController
{
    ...
    public function initController(\CodeIgniter\HTTP\RequestInterface $request, \CodeIgniter\HTTP\ResponseInterface $response, \Psr\Log\LoggerInterface $logger)
    {
        ...
        if (!$this->session->get('isLoggedIn') || $this->session->get('role') !== 'receptionist') {
    ...
    public function patients()
    {
        ...
        return view('auth/receptionist/patients', $data);
    }
    ...
    {
        return view('auth/receptionist/patient_form', ['patient' => null]);
    }
    ...
    public function editPatient($id)
    {
        ...
        return view('auth/receptionist/patient_form', $data);
    }
    ...
    public function viewPatient($id)
    {
        ...
        return view('auth/receptionist/patient_view', $data);
    }
    ...
    public function appointments()
    {
        ...
        return view('auth/receptionist/appointments', $data);
    }
    ...
    public function createAppointment()
    {
        ...
        return view('auth/receptionist/appointment_form', $data);
    }
    ...
    public function viewAppointment($id)
    {
        ...
        return view('auth/receptionist/appointment_view', $data);
    }
